				...
				<form id="insertForm" enctype="multipart/form-data">
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="modalStt" class="col-sm-2 col-form-label">Hình ảnh
									<small class="text-danger">*</small>
								</label>
								<img id="addImage" src="" style="max-width:400px; height:220px;" class="col-sm-10" />
                                <div class="col-sm-10">
                                    <input type="file" id="fileID" name="add-image" class="form-control-file" accept="image/png, image/jpeg">
									<button type="button" class="btn btn-primary mt-2" id="removeFileID" >xóa ảnh</button>
								</div>
                            </div>
						</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group row">
								...
								<img id="editImage" src="" style="max-width:400px; height:220px;" class="col-sm-10" />
											
							</div>
							<div class="form-group">
								<input type="file" id="editFileID" name="edit-image" class="form-control-file"
								accept="image/png, image/jpeg">
								<button type="button" class="btn btn-primary mt-2" id="removeEditFileID" >xóa ảnh</button>
							</div>
						</div>
						<div class="modal-footer" id="actionFormEdit">
							<button type="button" class="btn btn-secondary"
