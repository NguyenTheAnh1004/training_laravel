			...
			<form method="GET" id="searchForm" enctype="multipart/form-data">
				<div class="action-form">
					<div class="search-input d-flex">
						...
						<div class="form-group mr-4">
							<label for="address">Địa chỉ</label> <input type="text" name="address"
					...
					<div class="action d-flex justify-content-between">
						<div class="left">
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target="#addCustomerModal" class="btn-primary btn"
								onclick="handleChangeAction(false);">Thêm mới</button>
						</div>
						<div class="right">
							<button id="btnSearchCustomer" type="button" class="btn-primary btn" >Tìm
								kiếm</button>
				...
				<form id="insertForm">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group row">
								<label for="modalPhone" class="col-sm-2 col-form-label">Điện thoại
									<small class="text-danger">*</small>
								</label>
								<div class="col-sm-10">
								...
								<div class="ml-5">
									<small class="pl-5 ml-5 text-danger" id="errorPhone"></small>
								</div>
							</div>
							<div class="form-group row">
								<label for="modalAddress" class="col-sm-2 col-form-label">Địa chỉ
									<small class="text-danger">*</small>
								</label>
								<div class="col-sm-10">
								...
								<div class="ml-5">
									<small class="pl-5 ml-5 text-danger" id="errorAddress"></small>
								</div>
							</div>
							<div class="form-group row">
						...
						<div class="modal-footer" id="actionFormEdit">
							...
							<button type="button" id="btnSaveCustomer" class="btn btn-primary">Lưu</button>
						</div>
					</div>
				</form>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group row">
								...
								<div class="ml-5">
									<small class="pl-5 ml-5 text-danger" id="errorEditPhone"></small>
								</div>
							</div>
							<div class="form-group row">
								<label for="modalAddress" class="col-sm-2 col-form-label">Địa chỉ
								...
								<div class="ml-5">
									<small class="pl-5 ml-5 text-danger" id="errorEditAddress"></small>
								</div>
							</div>
							<div class="form-group row">
								<label for="" class="col-sm-2 col-form-label">Trạng thái</label>
						...
						<div class="modal-footer" id="actionFormEdit">
							<button type="button" class="btn btn-secondary"
								data-dismiss="modal">Hủy</button>
							<button type="button" id="btnEditCustomer" class="btn btn-primary">Lưu</button>
						</div>
					</div>
				</form>
			</div>
